...
For standalone installs, download the matching `lazymermaid_VERSION_OS_ARCH.tar.gz`
from [GitHub Releases](https://github.com/daviddwlee84/lazymermaid/releases), verify its
...
```sh
go install github.com/daviddwlee84/lazymermaid/cmd/lazymermaid@v0.1.1
# Update an existing Go installation through its original destination:
go install github.com/daviddwlee84/lazymermaid/cmd/lazymermaid@latest
```
...
python3 scripts/release.py check --project lazymermaid --binary lazymermaid --smoke
